...
export default function Home({ profiles }) {
  ...
  return (
    <div className="w-full h-full grid place-content-center gap-10 font-mono">
      <Head>
      ...
      <div className="text-xl flex flex-wrap justify-center items-center gap-10 max-w-4xl">
